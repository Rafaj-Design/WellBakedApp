          ...
          <div id='content_container'>
            <table style='margin-top: 10px;'>
              ...
              <tr>
                ...
                <td><a href='?page=2_projects&amp;script=3_0_0_0'><button>Edit</button></a></td>
              </tr>
              <tr>
                <td style='width: 350px;'>Translations</td>
                <td><a href='?page=2_projects&amp;script=3_0_1'><button>Edit</button></a></td>
              </tr>
              <tr>
                <td style='width: 350px;'>Killswitch</td>
                <td><a href='?page=2_projects&amp;script=3_0_2_0'><button>Edit</button></a></td>
              </tr>
            </table>
